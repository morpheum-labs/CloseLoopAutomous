...
// WebSocket gateways (including ZeroClaw, Clawlet, IronClaw, NemoClaw), NullClaw HTTP A2A (/a2a), CoPaw Console JSON-RPC (/console/api), InkOS CLI, and other runtime adapters.
