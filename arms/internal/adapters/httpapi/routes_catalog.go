...
func routeCatalog() []RouteEntry {
	return []RouteEntry{
		...
		{"GET", "/api/products/{id}/product-schedule", "product_schedules row or defaults (enabled, spec_json, updated_at)"},
		{"PATCH", "/api/products/{id}/product-schedule", "Upsert schedule {enabled?, spec_json?} — at least one field; gates autopilot TickScheduled when disabled"},
